...
import com.liyiwei.baselibrary.statusbar.fragment.components.SimpleImmersionFragment;
...
//        ImmersionBar.with(this).statusBarDarkFont(true).navigationBarColor(R.color.btn1).navigationBarDarkIcon(true).init();
//        ImmersionBar.with(this).navigationBarColor(R.color.btn13).keyboardEnable(false).init();
...
//        ImmersionBar.with(this).statusBarDarkFont(true, 0.2f).navigationBarColor(R.color.btn2).navigationBarDarkIcon(true).keyboardEnable(false)
