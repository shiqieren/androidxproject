...
import com.liyiwei.asyncallback.AsyncThread.AsyncCallback;
import com.liyiwei.asyncallback.AsyncThread.Callback;
import com.liyiwei.asyncallback.AsyncThread.EasyThread;

import java.util.concurrent.Callable;
import java.util.concurrent.Future;
import java.util.concurrent.TimeUnit;

import hongyi.asyncallback.R;

public class AsynCallbackActivity extends AppCompatActivity {
    private static final String TAG = "AsynCallbackActivity";
    ...
    private void toast(final String message, final Object... args) {
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(AsynCallbackActivity.this, String.format(message, args), Toast.LENGTH_SHORT).show();
                }
            });
        }
