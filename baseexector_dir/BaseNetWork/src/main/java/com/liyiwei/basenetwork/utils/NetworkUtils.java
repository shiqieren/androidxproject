...
public class NetworkUtils {
     ...
     * @return {@code true}: 是<br>{@code false}: 否
     */
    public static boolean getDataEnabled(Context appContext) {
        try {
     ...
     */
    public static void setDataEnabled(Context appContext, boolean enabled) {
        try {
            TelephonyManager tm = (TelephonyManager) appContext.getSystemService(Context.TELEPHONY_SERVICE);
     ...
     * @return {@code true}: 是<br>{@code false}: 否
     */
    public static boolean getWifiEnabled(Context appContext) {
     ...
     * @param enabled {@code true}: 打开<br>{@code false}: 关闭
     */
    public static void setWifiEnabled(Context appContext, boolean enabled) {
        WifiManager wifiManager = (WifiManager) appContext.getSystemService(Context
                .WIFI_SERVICE);
        if (enabled) {
     ...
     * @return 运营商名称
     */
    public static String getNetworkOperatorName(Context appContext) {
        TelephonyManager tm = (TelephonyManager) appContext.getSystemService(Context.TELEPHONY_SERVICE);
     ...
     * <p>需添加权限 {@code <uses-permission android:name="android.permission.ACCESS_NETWORK_STATE"/>}</p>
     *
     * @return 网络类型 <ul> <li>{@link NetworkType#NETWORK_WIFI   } </li> <li>{@link NetworkType#NETWORK_4G     } </li>
