package com.liyiwei.customlibrary.browser;
...
public class XBaseJsMapping extends Object implements IBaseJsMapping {
    ...
    @Override
    public void doGet(String url, String tag, int notifyId) {

    }

    @Override
    public void doPost(String url, String params, String tag, int notifyId) {

    }

    @Override
    public void download(String fileUrl, String saveFilename, String authorities, boolean showNotification, boolean isCallback, int notifyId) {
