...
public class CustomDefaultDialogUtils {
     ...
     * @return
     */
//    public static Dialog createWaitDialog(Context context, String msg, boolean isTransBg, boolean isCancelable) {
//        LayoutInflater inflater = LayoutInflater.from(context);
//        View v = inflater.inflate(R.layout.dialog_default_loading, null);             // 得到加载view
